...
def main():
    ...
    # ============================================================
    # 2. Define any arbitrary function here
    #    You can replace this with Gaussian, square wave, top-hat, etc.
    # ============================================================
    func = lambda x: np.sin(2 * np.pi * x) + 0.5 * np.sin(6 * np.pi * x)

    # ============================================================
    # 3. Convert function -> quantum statevector
    # ============================================================
    ...
    # ============================================================
    # 4. Analyze statevector using MPS
    # ============================================================
    ...
    print("exact fidelity =", report["exact_fidelity"])
